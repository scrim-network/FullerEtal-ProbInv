...
png(file="Scratch/Figures/SuppFigures/SF4_C.tif", family="Helvetica", width=6.7,
...
#ines(all.sflig$pdf, col=mypalette[9], lwd=2)
...
"Median & 90% C.I. (Little et al. 2013)","Median & 90% C.I. (IPCC AR5)",
...
png(file="Scratch/Figures/SuppFigures/SF3_C.tif", family="Helvetica", width=6.7, height=8.1, units="in",pointsize=12, res=300)
