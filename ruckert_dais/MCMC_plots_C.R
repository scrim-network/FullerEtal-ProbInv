...
png(file="Scratch/Figures/Fig1_C_mc.tif", family="Helvetica", width=6.7,
...
png(file="Scratch/Figures/Fig2_C_MC.tif", family="Helvetica", width=6.7,
...
png(file="Scratch/Figures/Fig3_C_MC.tif", family="Helvetica", width=6.7,
    height=5.4, units="in",pointsize=12, res=300)
par(mfrow=c(2,2),mgp=c(1.5,.5,0), mar=c(3.5,4,1,1)) # set figure dimensions
...
png(file="Scratch/Figures/Fig4_C_MC.tif", family="Helvetica", units="in", width=3.4, height=3, pointsize=11, res=300)
...
png(file="Scratch/Figures/SuppFigures/SFig3_C_MC.tif", family="Helvetica", width=6.7,
...
pdf(file="Scratch/Figures/SuppFigures/SFig4_C_MC.pdf", family="Helvetica", pointsize=12)
...
write.csv(table.parts, file="Scratch/Random_out/constraint_percent_MCMC.csv")
#---------- NO NOISE
...
write.csv(table.parts.nonoise, file="Scratch/Random_out/NoNoise_constraint_percent_MCMC.csv")
#------------------------------------- Figure 2 but with no added noise -------------------------------------------
# MCMC hindcasts & projection
png(file="Scratch/Figures/Fig2_NN_C_MC.tif", family="Helvetica", width=6.7,
    height=8.1, units="in",pointsize=12, res=300)
# pdf(file="Figures/Ruckertetal_dais90MCMC_Fig1.pdf", family="Helvetica", width=6.7, height=8.1, pointsize=12)
par(mfrow=c(3,2), mgp=c(1.5,.5,0), mar=c(4, 4, 2, 1))
